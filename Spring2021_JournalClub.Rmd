...
## Syllabus
* Download the Spring 2021 [syllabus](SQ21/SYLLABUS_PLACEHOLDER.pdf).
...
* OFFICE HOURS: Wednesdays, 9am - 10am PT via Zoom, **link available on Canvas and sent via email**
...
* You must submit 9/10 journal entries.
* You must (co-)facilitate 1/10 discussions and submit the accompanying document.
...
### Week 1
#### Seminar Speaker: TBD
##### Discussion Facilitator: Priya S.
  + Introduction / Syllabus Overview
  + Virtual Notebook [(link coming soon)]()
  + Reading [[PDF coming soon]()]
